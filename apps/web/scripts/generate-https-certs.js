#!/usr/bin/env node
/**
 * Generate HTTPS certs for local dev including your network IP.
 * Requires mkcert: brew install mkcert && mkcert -install
 *
 * Run: node scripts/generate-https-certs.js
 * Or with explicit IP: LOCAL_IP=192.168.0.120 node scripts/generate-https-certs.js
 */
...
function main() {
  ...
  console.log("Done. Certs saved to apps/web/certificates/");
}
