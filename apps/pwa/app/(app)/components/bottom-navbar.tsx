...
export function BottomNavbar() {
  ...
  return (
    <nav className="bottom-nav-safe fixed bottom-8 left-0 right-0 z-40 flex justify-center overflow-visible px-4 pb-4 pt-2">
      <div className="frosted-glass flex h-14 w-full max-w-sm items-center overflow-visible rounded-full border border-border/60 bg-background/95 px-1 py-2 shadow-lg">
