...
ARG RYBBIT_HOST=
ARG NEXT_PUBLIC_APP_RYBBIT_SITE_ID=
...
ENV NEXT_PUBLIC_APP_RYBBIT_SITE_ID=$NEXT_PUBLIC_APP_RYBBIT_SITE_ID
ENV NEXT_PUBLIC_RYBBIT_SCRIPT_URL=$NEXT_PUBLIC_RYBBIT_SCRIPT_URL

RUN printf "NEXT_PUBLIC_APP_URL=%s\nNEXT_PUBLIC_PWA_URL=%s\nNEXT_PUBLIC_GITHUB_URL=%s\nNEXT_PUBLIC_DONATE_URL=%s\nNEXT_PUBLIC_NOTIFICATIONS_WS_URL=%s\nNEXT_PUBLIC_VAPID_PUBLIC_KEY=%s\nRYBBIT_HOST=%s\nNEXT_PUBLIC_RYBBIT_SITE_ID=%s\nNEXT_PUBLIC_RYBBIT_SCRIPT_URL=%s\n" \
    "$NEXT_PUBLIC_APP_URL" "$NEXT_PUBLIC_PWA_URL" "$NEXT_PUBLIC_GITHUB_URL" "$NEXT_PUBLIC_DONATE_URL" "$NEXT_PUBLIC_NOTIFICATIONS_WS_URL" "$NEXT_PUBLIC_VAPID_PUBLIC_KEY" "$RYBBIT_HOST" "$NEXT_PUBLIC_APP_RYBBIT_SITE_ID" "$NEXT_PUBLIC_RYBBIT_SCRIPT_URL" > .env
